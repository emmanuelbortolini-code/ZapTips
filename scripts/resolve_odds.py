...
from app.odds_resolution import PickParaResolverOdds, calcular_odd_minima, resolver_odd_referencia
...
def aplicar_resolucao(
    ...
    encontrada = resolver_odd_referencia(pick, casas_licenciadas, odds_por_fixture)
